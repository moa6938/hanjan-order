...
begin
  ...
  insert into public.orders (customer_name, party_size, items, note)
  values (
...
revoke all on function public.create_order(jsonb, text, text, integer) from public;
...
grant execute on function public.create_order(jsonb, text, text, integer) to anon, authenticated;
